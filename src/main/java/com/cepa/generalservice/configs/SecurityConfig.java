...
import com.cepa.generalservice.filters.AuthenticationFilter;
import com.cepa.generalservice.filters.ExceptionHandlerFilter;
...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web.ignoring().antMatchers("/swagger-ui/**", "/v3/api-docs/**", "/api/authentication/**","/api/subjects");
    }
}
